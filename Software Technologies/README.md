...
## Exercises.
1. <a href="#"> HTTP BASICS AND DATABASES - EXERCISES </a> 
2. <a href="#"> HTML5 AND CSS - EXERCISES </a> 
3. <a href="#"> HTML5 AND CSS - EXERCISES (SLICE AND DICE THE BLOG WEB DESIGN) </a> 
4. <a href="#"> JAVASCRIPT: SYNTAX AND BASIC WEB - EXERCISES </a>
5. <a href="#"> JAVASCRIPT: EXPRESSJS OVERVIEW - EXERCISES </a>
6. <a href="#"> JAVASCRIPT: BLOG BASIC FUNCTIONALITY - EXERCISES </a>
7. <a href="#"> PHP: SYNTAX AND BASIC WEB - EXERCISES </a>
